...
if [ "$(uname -m)" = 'aarch64' ]; then
    ...
    if [[ "${NODE_NAME}" =~ "ubuntu1604-dev-48c-256g-1" ]]; then
        POD_NAME='virtual1'
    else
        POD_NAME='virtual2'
    fi
...
# set the location to descriptor files
git clone https://gerrit.akraino.org/r/iec
EXTRA_ARGS="-b file://${WORKSPACE}/iec/ci ${EXTRA_ARGS:-}"

# construct the command
rm -rf fuel
#git clone https://github.com/opnfv/fuel.git
git clone https://github.com/alexandruavadanii/fuel
