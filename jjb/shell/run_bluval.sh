...
sh validation/bluval/blucon.sh $options "$blueprint_name"
...
then
    ...
    NEXUS_URL="https://nexus.akraino.org/content/sites/logs/$LAB_SILO/bluval_results/$blueprint_name/$VERSION/$TIMESTAMP/results/"
